...
### Added
- `grazy news` - RSS news from ORF Steiermark & Kleine Zeitung
- `grazy air` - Air quality index (PM2.5, PM10, AQI)
- `grazy poi` - POI search via Overpass (restaurants, cafes, bars, etc.)
